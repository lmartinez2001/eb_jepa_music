...
from music.models.drop import DropPath
...
class DSTformer(nn.Module):
    def __init__(self, dim_in=3, dim_out=3, dim_feat=256, dim_rep=512,
        ...
        self.pos_embed = nn.Parameter(torch.zeros(1, num_joints + 1, dim_feat))
        self.cls_token = nn.Parameter(torch.zeros(1, 1, dim_feat))
    ...
    def forward(self, x, return_rep=False):   
        ...
        cls_token = self.cls_token.expand(BF, -1, -1)
